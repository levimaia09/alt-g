...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="css/user_css/owl.carousel.css">
    <link rel="stylesheet" href="css/user_css/responsive.css">
    <link rel="stylesheet" href="css/user_css/style.css">
...
<!-- header area -->
    ...
    <!-- jQuery sticky menu -->
    <script src="/js/user_js/owl.carousel.min.js"></script>
    <script src="/js/user_js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/js/user_js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/js/user_js/main.js"></script>

    <!-- Slider -->
    <script type="text/javascript" src="/js/user_js/bxslider.min.js"></script>
	<script type="text/javascript" src="/js/user_js/script.slider.js"></script>
</body>
</html>