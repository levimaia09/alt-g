...
let photoEdit = document.getElementById("imgphoto-edit");
let fileEdit = document.getElementById("flimage-edit");
let valueImgProductEdit = document.getElementById("value_img_product_edit");

photoEdit.addEventListener('click', ()=>{
  file.click();
});

fileEdit.addEventListener('change', (event) => {
  ...
  reader2.onload = () => {
      photoEdit.src = reader2.result;
      valueImgProductEdit.value = "changed";
  }

  reader2.readAsDataURL(fileEdit.files[0]);
});
...
(function ($) {
  ...
  try {
    ...
    var data3 = [120, 60, 55, 50, 65, 80, 57, 70, 105, 115]
    var data4 = [20, 70, 80, 100, 56, 53, 80, 75, 65, 90]
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: ['Janeiro', 'Fervereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro'],
          datasets: [
            {
              label: 'My First dataset',
